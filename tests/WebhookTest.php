...
class WebhookTest extends TestCase
{
    ...
    {
        $this->expectException(\CoinbaseCommerce\Exceptions\SignatureVerificationException::class);
    ...
    {
        $this->expectException(\CoinbaseCommerce\Exceptions\InvalidResponseException::class);
